<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGame.aspx.cs" Inherits="Pages_Admin_AddGame" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="addgamebox">
            ...
            <div class="functionbtn">
                游戏价格：
            <br />
                <asp:TextBox ID="tbGamePrice" runat="server" CssClass="inputcss" Height="25px"></asp:TextBox>
            ...
            <div class="functionbtn">
                游戏介绍：
            <br />
                <asp:TextBox ID="tbGameIntro" runat="server" Height="77px" TextMode="MultiLine" CssClass="inputcss"></asp:TextBox>
            ...
            <div class="functionbtn">
                ...
                <br />
                <div>
                    <asp:Button ID="btnUploadImg" runat="server" Text="上传LOGO" OnClick="btnUploadImg_Click" CssClass="niceButton2" />
                    <br />
            ...
            <br />
            <div class="functionbtn">
                <asp:Button ID="btnUploadAll" runat="server" Text="点击上传全部" Height="44px" OnClick="btnUploadAll_Click" CssClass="niceButton2" />
                <br />
